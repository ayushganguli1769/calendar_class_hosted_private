      ...
      $(".file-chooser__input").on("change", function () {
        ...
        for (var i = 0; i < files.length; i++) {
          ...
          if (check === "valid") {
            ...
            $(".file-chooser__input").attr('name',"my_hidden_file_input_number" + String(uploadId))
            $(".hidden-inputs").append($(".file-chooser__input"));//change the code here and add a name variable here
